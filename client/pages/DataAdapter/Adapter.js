...
import { DeviceModel } from "forge-dataviz-iot-data-modules/client/data/Hyperion.Data.DeviceModel";
import { DeviceData, AggregatedValues } from "forge-dataviz-iot-data-modules/client/data/Hyperion.Data.DataModel";
import { getTimeInEpochSeconds, getPaddedRange } from "forge-dataviz-iot-data-modules/client/../shared/Utility";
import { DateTimeSpan } from "forge-dataviz-iot-data-modules/client/data/Hyperion.Data.Storage";
            ...
            .then((rawDeviceModels) => {
                ...
                rawDeviceModels.forEach((rdm) => {
                    ...
                    rdm.deviceProperties.forEach((rdp) => {
                        ...
                        ndp.dataType = rdp.propertyType;
                        ndp.dataUnit = rdp.propertyUnit;
                        ndp.firstDay = rdp.firstDay;
                        ndp.lastDay = rdp.lastDay;
                        ndp.rangeMin = rdp.rangeMin ? rdp.rangeMin : undefined;
                        ndp.rangeMax = rdp.rangeMax ? rdp.rangeMax : undefined;
                    });
...
export class MySqlDataAdapter extends RestApiDataAdapter {
    /**
     * Constructs an instance of RestApiDataAdapter.
     */
     constructor(provider = "synthetic", baseName = "") {
        ...
        return Promise.all(promises).then((deviceInfosList) => {
            ...
            deviceModels.forEach((deviceModel, index) => {
                ...
                deviceInfos.forEach((deviceInfo) => {
                    ...
                    device.number = deviceInfo.number;
                });
            });
