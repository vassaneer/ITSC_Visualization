                    ...
                    <React.Fragment>
                        ...
                        {properties.map((property) => (
                            <React.Fragment key={`${props.hoveredDeviceInfo.id}-${property}`}>
                                ...
                                >
                                    {currentDeviceData && chartData["properties"][property].seriesData.length!=0  ? currentDeviceData[property] : ""}
                                </span>
                                {chartData["properties"][property].seriesData.length!=0 && ( <DataChart
